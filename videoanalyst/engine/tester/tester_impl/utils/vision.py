...
def visualize_grid_to_grid_with_cls(att_map, grid_index, image, grid_size=35, alpha=0.6):
    if not isinstance(grid_size, tuple):
        grid_size = (grid_size, grid_size)
    ...
    mask = attention_map.reshape(grid_size[0], grid_size[1])
    ...
    ax[1].axis('off')
    plt.savefig('/data1/yinhf/projects/STNet/videoanalyst/engine/tester/tester_impl/utils/attn.png')
